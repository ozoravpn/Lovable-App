...
const pricePerCoin = 0.014; // Price per coin (e.g., 1.40 / 100 coins)
let customValueStr = "";
...
function selectPackage(element) {
    ...
    if (element.id !== 'btnCustom') {
        ...
        // Use parseFloat for decimal prices
...
function updateBuyButton() { 
    // Mengubah teks menjadi 'Confirm' saja
    document.getElementById('btn-buy-text').innerText = 'Confirm'; 
}
